<template>
  <div>
    ...
    <p class="md:text-lg text-justify text-black">
      ...
      Dabei fanden die Forscher eine signifikante moderate negative Korrelation
    ...
    <p class="md:text-lg text-justify text-black">
      ...
      Wissenschaftler primär die internationalen Zusammenhänge zwischen
      Temperatur und Luftfeuchtigkeit mit der Ausbreitungsrate des Coronavirus.
    ...
    <p class="md:text-lg text-justify text-black">
      ...
      dass sich die verglichenen Länder teilweise stark in Klima, Wohlstand und
      Kultur unterscheiden. Dies kann signifikante Auswirkungen auf die
      Statistik haben und dazu führen, dass scheinbare Zusammenhänge an anderen
      Faktoren als den Klimaparametern liegen, oder die Effekte einen
      unterschiedlichen Einfluss auf die Ausbreitung haben. Ein Beispiel hierfür
      ist, dass sich in einigen Ländern die meteorologischen Faktoren wie
      Sonnenstunden und durchschnittliche Temperatur wesentlich mehr auf die
      gesamten Fallzahlen auswirken als auf die Todeszahlen. In der Studie wird
      zudem erwähnt, dass trotz der besseren Lebensumstände und geringerer
      ...
      wurde keine direkte Untersuchung der Daten über Fallzahlen im Zusammenhang
    ...
    <p class="md:text-lg text-justify text-black">
      ...
      weisen mehrfach darauf hin, dass meteorologische Faktoren, wie die
      ...
      zur landesinternen Entwicklung über die Zeit mit verschiedenen Ländern
      getrieben, um so potentiell neue Erkenntnisse zu gewinnen.
    </p>
  </div>
</template>
